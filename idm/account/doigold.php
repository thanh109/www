...
$sql2="select * from $database2.t_roles where userid='".$userid."' and username='".$userid."'";
...
<div class="col-lg-12 col-xs-12">
        <table>	
				<form action="recharge.php?act=50gold&username=<?php echo $_SESSION['username'];?>&id=<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=100gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=200gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=400gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=700gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=1000gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
		...
		<form action="recharge.php?act=5000gold&username=<?php echo $_SESSION['username'];?>&id==<?php echo $tennhanvat ?>" method="post">
