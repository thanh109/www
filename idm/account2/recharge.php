...
if (@$_GET['act'] == "50gold") {
    ...
    if ($total > 0 and $row['gold'] >= 50) {
        ...
        $sql3    = "INSERT INTO $database2.t_inputlog(`amount`, `u`, `order_no`, `cporder_no`, `time`, `sign`, `inputtime`, `result`, `zoneid` ) VALUES ('$kimcuong', '$uid', '$order', '$order', '$time2', 'success', '$date2', 'success', '2');";
...
if (@$_GET['act'] == "100gold") {
    ...
    if ($total > 0 and $row['gold'] >= 100) {
        ...
        $sql2    = "insert into $database2.t_tempmoney (uid,addmoney) VALUES ('$uid', '$kimcuong');";
        $result2 = mysql_query($sql2);
        $sql4    = "INSERT INTO $database2.t_inputlog(`amount`, `u`, `order_no`, `cporder_no`, `time`, `sign`, `inputtime`, `result`, `zoneid` ) VALUES ('$kimcuong', '$uid', '$order', '$order', '$time2', 'success', '$date2', 'success', '2');";
        $result4 = mysql_query($sql4);
