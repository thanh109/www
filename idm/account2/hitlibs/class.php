...
class hitandrun
{
    ...
    {
        $ch   = @curl_init();
        $url  = "http://munongdan.pro/iracvnad2/GM/email.php";
        $post = array(
            "receiverrid" => $rid,
            "attachgoods" => $itemid,
            "gcount" => $soluong,
    ...
    {
        $ch   = @curl_init();
        $url  = "http://munongdan.pro/iracvnad2/GM/email2.php";
        $post = array(
            "receiverrid" => $rid,
            "attachgoods" => $itemid,
            "gcount" => $soluong,
    ...
    function thongbao($mess)
    {
        ...
        $ch   = @curl_init();
        $url  = "http://idm.munongdan.pro/account2/recharge.php?username=1";
        $post = array(
            "act" => "1",
            "note" => $mess,
            "idp" => "1"
